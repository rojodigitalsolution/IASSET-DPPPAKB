...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_pengajuan'])) {
    ...
    if (mysqli_query($con, $query)) {
        echo "<script>alert('Pengajuan aset berhasil ditambahkan.'); window.location.href = '?page=pengajuan-show';</script>";
    } else {
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="">
          ...
          <button type="submit" class="btn btn-primary" name="submit_pengajuan" href="?page=pengajuan-show">Tambah Pengajuan</button>
          <a href="?page=pengajuan-show" class="btn btn-danger"><i class="fas fa-chevron-left"></i>
                Kembali</a>
        </form>
      </div>
    </div>
