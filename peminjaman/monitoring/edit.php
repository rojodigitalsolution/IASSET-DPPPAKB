...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "UPDATE peminjaman SET nama_barang='$nama_barang', tanggal_pinjam='$tanggal_pinjam', tanggal_kembali='$tanggal_kembali', status_pinjam='$status_pinjam' WHERE id_peminjaman='$id'");
